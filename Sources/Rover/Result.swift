...
public final class Result {
    ...
    public func get(string rowIdx: Int, _ colIdx: Int) -> String? {
    ...
    public func get(halfHitch rowIdx: Int, _ colIdx: Int) -> HalfHitch? {
        guard let string = get(string: rowIdx, colIdx) else { return nil }
        return Hitch(string: string).halfhitch()
    }

    public func get(hitch rowIdx: Int, _ colIdx: Int) -> Hitch? {
        guard let string = get(string: rowIdx, colIdx) else { return nil }
        return Hitch(string: string)
    }

    public func get(iso8601 row: Int, _ col: Int) -> Date? {
        guard let halfHitch = get(halfHitch: row, col) else { return nil }
        return halfHitch.description.toISO8601()
    }

    public func get(date row: Int, _ col: Int) -> Date? {
        guard let halfHitch = get(halfHitch: row, col) else { return nil }
        return halfHitch.description.date()
    }

    public func get(bool row: Int, _ col: Int) -> Bool? {
        guard let halfHitch = get(halfHitch: row, col) else { return nil }
        // 116 is 't'
        return halfHitch[0] == 116 && halfHitch.count == 1
    }

    public func get(int row: Int, _ col: Int) -> Int? {
        guard let halfHitch = get(halfHitch: row, col) else { return nil }
        return halfHitch.toInt()
    }

    public func get(int8 row: Int, _ col: Int) -> Int8? {
        guard let halfHitch = get(halfHitch: row, col) else { return nil }
        guard let int = halfHitch.toInt() else { return nil }
        return Int8(int)
    }

    public func get(int16 row: Int, _ col: Int) -> Int16? {
        guard let halfHitch = get(halfHitch: row, col) else { return nil }
        guard let int = halfHitch.toInt() else { return nil }
        return Int16(int)
    }

    public func get(int32 row: Int, _ col: Int) -> Int32? {
        guard let halfHitch = get(halfHitch: row, col) else { return nil }
        guard let int = halfHitch.toInt() else { return nil }
        return Int32(int)
    }

    public func get(int64 row: Int, _ col: Int) -> Int64? {
        guard let halfHitch = get(halfHitch: row, col) else { return nil }
        guard let int = halfHitch.toInt() else { return nil }
        return Int64(int)
    }

    public func get(uint row: Int, _ col: Int) -> UInt? {
        guard let halfHitch = get(halfHitch: row, col) else { return nil }
        guard let int = halfHitch.toInt() else { return nil }
        return UInt(int)
    }

    public func get(uint8 row: Int, _ col: Int) -> UInt8? {
        guard let halfHitch = get(halfHitch: row, col) else { return nil }
        guard let int = halfHitch.toInt() else { return nil }
        return UInt8(int)
    }

    public func get(uint16 row: Int, _ col: Int) -> UInt16? {
        guard let halfHitch = get(halfHitch: row, col) else { return nil }
        guard let int = halfHitch.toInt() else { return nil }
        return UInt16(int)
    }

    public func get(uint32 row: Int, _ col: Int) -> UInt32? {
        guard let halfHitch = get(halfHitch: row, col) else { return nil }
        guard let int = halfHitch.toInt() else { return nil }
        return UInt32(int)
    }

    public func get(uint64 row: Int, _ col: Int) -> UInt64? {
        guard let halfHitch = get(halfHitch: row, col) else { return nil }
        guard let int = halfHitch.toInt() else { return nil }
        return UInt64(int)
    }

    public func get(double row: Int, _ col: Int) -> Double? {
        guard let halfHitch = get(halfHitch: row, col) else { return nil }
        return halfHitch.toDouble()
    }

    public func get(float row: Int, _ col: Int) -> Float? {
        guard let halfHitch = get(halfHitch: row, col) else { return nil }
